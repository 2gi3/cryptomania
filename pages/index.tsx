...
const Home: NextPage = ({
  ...
  return (
    <div>
      ...
      <header className="w-full h-10 flex justify-center items-center mb-5">
        <h1 className="text-xl font-bold underline">Cryptomaina</h1>
      </header>
      <main className="p-2">
        <div className="flex flex-row justify-center mb-5">
          <section className="w-full  flex flex-col justify-center gap-1 max-w-xs items-center h-60 p-5 min-w-min  ">
            <h1>Average ticker values</h1>
            <h2>&rdquo;Last&rdquo; value for BTC/USD</h2>
            <p>{averageLast}</p>
          </section>
          <section className="mb-5 w-32 border-solid border-2 border-gray-300">
            <div>
