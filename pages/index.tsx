...
export default function Home({
  ...
  // const targetPairData = bitstampData.filter((pair: any) => {
  //   pair.pair == selectedPair
  //   return pair.pair == selectedPair
  // })
  // const targetPairValues = targetPairData[0]

  useEffect(() => {
    // console.log(targetPairValues)
    console.log(bitstampData)
    console.log(coinbaseData)
    console.log(finexData)
      ...
      <div className={styles.container}>
        ...
        <main className={styles.main}>
          <section className={styles.averageTickerContainer}>
            ...
            {bitstampData.map((entry: any, index: any) =>
              index < 30 ? (
